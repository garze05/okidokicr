    ...
    <div className="relative mx-auto mb-12 w-full max-w-3xl">
      <div className="relative">
        ...
        <input
          ...
          className="text-black-okidoki text-md focus:border-primary-500 focus:ring-primary-500 w-full rounded-3xl bg-gray-300 py-2 pr-4 pl-12 shadow-2xl transition-all duration-300 hover:bg-gray-100 focus:bg-gray-50 focus:ring-3 focus:outline-none sm:py-3 sm:text-lg"
        />
      </div>
      {results.length > 0 && (
        <ul className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-xl bg-white shadow-lg">
          {results.map((r) => (
            <li
              key={r.item.id}

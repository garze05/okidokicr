    ...
    <div className="min-h-screen bg-base-200">
      <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="text-gray-600 text-end mb-2">Sesión activa restante: {timeLeft}</div>
      ...
      {/* TABS */}
      <div className="container flex justify-between items-center mx-auto mt-10 mb-6">
        ...
        >
          {activeSection === 'catalog' ? '+ Agregar Servicio' : '+ Agregar Etiqueta'}
        </button>
      </div>
      {/* CATÁLOGO */}
      {activeSection === 'catalog' && (
        <div className="bg-base-100 shadow-xl rounded-lg p-6">
          <h3 className="text-xl font-bold mb-4">Administración de Servicios</h3>
          <p className="mb-4">Añada, edite, o elimine cualquier servicio ofrecido en el catálogo de OkiDoki.</p>
          {loading ? (
            ...
            <div className="">
              <div className="mb-6 max-w-lg">
                ...
                <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  <input
                    type="text"
                    className="input input-bordered w-full mb-4 pl-10" // Added pl-10 for icon
                      ...
                      <tr key={s.id} className="hover">
                        ...
                        <td>
                          <div className="flex space-x-2">
                            <a href={`/catalogo/${s.id}`} className="btn btn-ghost btn-sm">Ver</a>
                            <a href={`/admin/editar/servicio/${s.id}`} className="btn btn-ghost btn-sm">Editar</a>
                            <button className="btn text-error btn-ghost btn-sm" onClick={() => alert(`Eliminar servicio ${s.id}`)}>
                              Eliminar
                            </button>
                          </div>
                        </td>
      ...
      {activeSection === 'tags' && (
        <div className="bg-base-100 shadow-xl rounded-lg p-6">
          ...
          {loading ? (
            ...
            <div className="">
              <div className="mb-6 max-w-lg"> {/* Container for search bar */}
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <SearchIcon />
                  </span>
                  <input
                    type="text"
                    className="input input-bordered w-full mb-4 pl-10" // Style consistent with services search
